...
const HeroSkeleton = () => {
  return (
    <div className="container flex flex-col-reverse md:flex-col lg:grid lg:grid-cols-2 items-center lg:items-start text-center lg:text-start pt-24 lg:pt-44 gap-8 lg:gap-12
       mb-6  md:mb-0
       ">
      {/* المحتوى - Skeleton */}
        ...
        <div>
          ...
          >
            ...
            <div className="flex gap-2 items-start lg:items-center">
              ...
              <p>
                {hero?.description || "Physical therapy is a way of life… with a touch of everyday care."}
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <a href={hero?.secondary_link || "#"} className="mainBtn orange light">
